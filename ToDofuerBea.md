...
- Vollstaendige Konto- und Datenloeschung bauen: Identitaet bestaetigen, Account entfernen, personenbezogene Daten loeschen oder anonymisieren, Fotos entfernen, Gruppen-/Kommentarspuren sauber behandeln.
- Loeschanfragen aus `account_deletion_requests` in eine Admin-Ansicht ueberfuehren.
